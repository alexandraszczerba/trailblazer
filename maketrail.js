// Access Cesium from the global window object
const Cesium = window.Cesium;

// Set your Cesium Ion access token
Cesium.Ion.defaultAccessToken = 'YOUR_CESIUM_ION_ACCESS_TOKEN';

// Initialize the Cesium Viewer with terrain and imagery providers
const viewer = new Cesium.Viewer('cesiumContainer', {
    ...
    imageryProvider: Cesium.createWorldImagery()  // Add imagery provider
});
        ...
        if (Cesium.defined(earthPosition)) {
            ...
            Cesium.sampleTerrainMostDetailed(viewer.terrainProvider, [cartographicPosition])
                .then((updatedPositions) => {
                    ...
                    // Calculate distances from the last point
